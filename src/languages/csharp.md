...
1. Conditional Statements (`if-else`, `switch`)
   ...
   - Learn about the different types of conditional statements in C# (`if-else`,
     `switch`)
   - Understand how to use logical operators (`AND`, `OR`, `NOT`) in C#
     conditional statements
   - Practice writing conditional statements to control program flow based on
     conditions. For example, create a simple program that outputs different
     responses based on the user input.
...
2. Loops (`for`, `while`, `do-while`)
   ...
   - Practice writing loops to repeat code based on certain conditions. For
     example, create a program that prints out all even numbers between 0 and a
...
3. Functions in C# (creating and calling)
   ...
   - Practice writing functions that perform simple tasks like a function that
...
5. Returning Values from Functions
   ...
   - Practice using functions to perform complex tasks and return values to the
     main program.
...
1. Introduction to Object-Oriented Programming (OOP) Concepts
   ...
   - Learn about the key concepts of OOP, including encapsulation, inheritance,
     and polymorphism
...
4. Inheritance and Polymorphism in C#
   ...
   - Create a program that uses polymorphism and inheritance to create objects
...
5. Interfaces and Abstract Classes in C#
   ...
   - Practice creating interfaces and abstract classes to define common behavior
     for classes. For example, recreate the program you created in the last
     section, but incorporate interfaces and/or abstract classes.
...
1. Test Driven Development in C#
   ...
   - Research the [NUnit](https://nunit.org/),
     ...
     and [xUnit.net](https://xunit.net/) unit testing framework. Determine which
     is best based on your company tech stack.
   - Go back to the mini-project you made from the last section and create some
     tests for functions you you wrote.
...
2. Exception Handling in C#
   ...
   - Understand the importance of exception handling for writing robust and
     reliable programs
   - Go back to a previous section's code and identify potential exceptions and
...
3. Handling Exceptions with `try-catch` Blocks
   ...
   - Go back to a previous section's code and practice handling exceptions in C#
     programs using `try-catch` blocks
...
4. Reading and Writing Files in C#
   ...
   - Understand how to handle exceptions that may occur when reading or writing
     files
...
5. Streams and Byte Arrays in C#
   ...
   - Understand how to use streams to read and write data from files and other
     sources
...
2. Generics in C#
   ...
   - Understand how to use generic types and methods to write reusable and
     flexible code
   - Practice using generic types and methods in C# programs to perform complex
     tasks
...
3. LINQ (Language Integrated Query) in C#
   ...
   - Practice using LINQ to perform complex data queries and manipulations in C#
     programs

4. Asynchronous Programming in C#

   - Learn about asynchronous programming in C# programming
   - Understand how to use the async and await keywords to write asynchronous
     code
