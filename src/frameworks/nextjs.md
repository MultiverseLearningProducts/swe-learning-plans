...
>[Next.js has a great tutorial](https://nextjs.org/learn/foundations/about-nextjs) that covers a lot of the components of this learning plan. This is embedded throughout, but you may find it helpful to do the entire tutorial at once!
...
4. Build Something! 🔨
    ...
    - **Idea #2 - E-Commerce Website**: Build an online store that contains multiple pages (Home, Products, Shopping Cart, Checkout, etc.) that a user can navigate between.
...
- **Learn related technologies**: Next.js is just one piece of the modern web development stack, and there are many related technologies that you can learn to expand your skill set. Consider learning about GraphQL and other popular web development tools and technologies.